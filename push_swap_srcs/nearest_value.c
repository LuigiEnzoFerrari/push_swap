...
/*
** Return the nearest increment value to find the first occurrence of pivot or above
** on the stack. Return a positive value if the first occurrence is closest to the start of the stack
** and return a negative value if the first occurrence is closest to the end of the stack.
** if the distance is equal in both direction return a positive number.
*/
